...
REM set topdir=%PHREEQC_ROOT%
set topdir=..
set data=%topdir%\examples
REM prog="%topdir%\bin\ClrRelease\phreeqc.exe"
set prog="%topdir%\ClrRelease\phreeqc.exe"
REM prog_nochart="%topdir%\bin\Release\phreeqc.exe"
set prog_nochart="%topdir%\Release\phreeqc.exe"
set prognm=PHREEQC
...
echo    %name%
echo %prog% "%infile%" %outfile% "%DB%\phreeqc.dat" %name%.log
