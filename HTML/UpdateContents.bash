...
export BAS=`grep 'The Basic Interpreter</H2>' phreeqc3-61.htm | sed "s/^.*\([0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]\_[0-9][0-9][0-9][0-9][0-9]\)/\1/" | sed "s/\([0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]\).*/\1/"`
#echo $BAS
...
#	phreeqc3-55.htm
#	Examples</H2>
export EXAM=`grep 'Examples</H2>' phreeqc3-62.htm | sed "s/^.*\([0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]\_[0-9][0-9][0-9][0-9][0-9]\)/\1/" | sed "s/\([0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]\).*/\1/"`
#echo $EXAM
...
#	phreeqc3-78.htm
#	References Cited</H2>
export REF=`grep 'References Cited</H2>' phreeqc3-85.htm | sed "s/^.*\([0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]\_[0-9][0-9][0-9][0-9][0-9]\)/\1/" | sed "s/\([0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]\).*/\1/"`
#echo $REF

#xxxProgrammersxxx
#	phreeqc3-79.htm
#	Keyword Data Blocks for Programmers</H2>
export PROG=`grep 'Keyword Data Blocks for Programmers</H2>' phreeqc3-86.htm | sed "s/^.*\([0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]\_[0-9][0-9][0-9][0-9][0-9]\)/\1/" | sed "s/\([0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]\).*/\1/"`
#echo $PROG
