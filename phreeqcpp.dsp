...
# ADD CPP /nologo /W3 /GX /O2 /I "$(DEV_GMP_INC)" /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_MBCS" /YX /FD /c
...
# ADD CPP /nologo /W3 /Gm /GX /ZI /Od /I "$(DEV_GMP_INC)" /I "$(DEV_XERCES)\include" /I ".\src\phreeqc" /D "WIN32_MEMORY_DEBUG" /D "INVERSE_CL1MP" /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /YX /FD /GZ /c
...
# ADD LINK32 xerces-c_2.lib gmpDebug.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /debug /machine:I386 /pdbtype:sept /libpath:"$(DEV_GMP_LIB)" /libpath:"$(DEV_XERCES)\lib"
...
SOURCE=.\src\cxxKinetics.cxx
# End Source File
# Begin Source File

SOURCE=.\src\cxxMix.cxx
# End Source File
# Begin Source File
...
SOURCE=.\src\SurfaceCharge.cxx
# End Source File
# Begin Source File

SOURCE=.\src\SurfaceComp.cxx
# End Source File
# Begin Source File
