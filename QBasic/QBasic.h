#ifndef _INC_QBASIC_H
#define _INC_QBASIC_H
...
class QBasic: public PHRQ_io
{
public:
	QBasic(PHRQ_io *phrq_io=NULL);
	~QBasic();
...
struct LOC_exec
{
	...
	QBasic::varrec * findvar(struct LOC_exec *LINK);
	QBasic::valrec factor(struct LOC_exec *LINK);
	QBasic::valrec upexpr(struct LOC_exec * LINK);
	QBasic::valrec term(struct LOC_exec * LINK);
	QBasic::valrec sexpr(struct LOC_exec * LINK);
	QBasic::valrec relexpr(struct LOC_exec * LINK);
	QBasic::valrec andexpr(struct LOC_exec * LINK);
