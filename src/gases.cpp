...
*/
{
	...
	//gas_binary_parameters[p = { "H2O(g)", "CO2(g)" }] = 0.19;
	//gas_binary_parameters[p = { "H2O(g)", "H2S(g)" }] = 0.19;
	//gas_binary_parameters[p = { "H2O(g)", "H2Sg(g)" }] = 0.19;
	//gas_binary_parameters[p = { "H2O(g)", "CH4(g)" }] = 0.49;
	//gas_binary_parameters[p = { "H2O(g)", "Mtg(g)" }] = 0.49;
	//gas_binary_parameters[p = { "H2O(g)", "Methane(g)" }] = 0.49;
	//gas_binary_parameters[p = { "H2O(g)", "N2(g)" }] = 0.49;
	//gas_binary_parameters[p = { "H2O(g)", "Ntg(g)" }] = 0.49;
	//gas_binary_parameters[p = { "H2O(g)", "Ethane(g)" }] = 0.49;
	//gas_binary_parameters[p = { "H2O(g)", "Propane(g)" }] = 0.55;
	...
	for (i = 0; i < gas_unknowns.size(); i++)
	{
		...
		for (i1 = 0; i1 < gas_unknowns.size(); i1++)
		{
			...
			p = { phase_ptr->name, phase_ptr1->name };
			...
			{
				p = { phase_ptr1->name, phase_ptr->name };
				gas_pair_it = gas_binary_parameters.find(p);
			}
			if (gas_pair_it != gas_binary_parameters.end())
			{
				a_aa *= (1.0 - gas_pair_it->second);
			}
